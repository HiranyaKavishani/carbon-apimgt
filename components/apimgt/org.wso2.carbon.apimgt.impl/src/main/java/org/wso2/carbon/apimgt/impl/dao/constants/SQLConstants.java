...
public class SQLConstants {
  ...
  //--------------------
    ...
    public static final String REMOVE_BULK_APIS_DATA_FROM_AM_API_SQL = "DELETE FROM AM_API WHERE API_UUID IN (?)";

    public static final String DELETE_BULK_API_WORKFLOWS_REQUEST_SQL = "DELETE FROM AM_WORKFLOWS WHERE WF_REFERENCE " +
            "IN (SELECT CONVERT(API.API_ID, CHAR) FROM AM_API API WHERE API.API_UUID IN (?)) AND WF_TYPE=AM_API_STATE)";

    public static final String DELETE_BULK_GW_PUBLISHED_API_DETAILS = "DELETE FROM AM_GW_PUBLISHED_API_DETAILS WHERE " +
            "API_ID IN (SELECT API.API_ID FROM AM_API API WHERE API.API_UUID IN (?))";
    ...
    public static class APIRevisionSqlConstants {
        ...
        static final String GET_API_REVISION_DEPLOYMENTS
                ...
                "MAX(t3.DISPLAY_ON_DEVPORTAL) AS DISPLAY_ON_DEVPORTAL, MAX(t3.DEPLOY_TIME) AS DEPLOY_TIME " +
                "FROM " +
